# My own Web page <!-- omit in toc -->

  <img src="https://img.shields.io/badge/featured%20on-JekyllThemes-red.svg" height="20" alt="Jekyll Themes Shield" >
</a>

**My own Web page** contains my education, experience and certificates. It is built on [Poole](https://github.com/poole/poole) and [Pure](https://purecss.io/).
...
- title: Twitter
  ...
  icon: fab fa-twitter
- title: GitHub
  url: https://github.com/Elena-aljebrin/Elena-aljebrin.github.io/blob/master/_posts/2020-10-01-releasing-not-pure-poole-v0-1-0.md
  icon: fab fa-github
```
